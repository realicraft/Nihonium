...
__version__ = versions.Version(1, 2)
nihonium_minver = versions.Version(0, 4, 2) # This defines the minimum version of Nihonium needed to run these commands.
...
def suggest(bot_data, *suggestion):
